...
billing on Account delete (stores may keep charging) and deferred “delete freely, leave the
Organization running” until ownership-transfer UX is first-class. Safer default for the launchpad:
